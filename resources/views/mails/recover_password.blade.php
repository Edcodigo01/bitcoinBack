    ...
    <div class="container2">
        ...
        <div class="card"
            ...
            {{-- <img src="{{ $message->embed(public_path() . '/images/logotipos/klikler-email.jpg') }}" /> --}}
                ...
                <br>
                <h3 class="text-primary" >Recuperación de contraseña {{env('APP_NAME')}}</h3>

                <h4 class="text-dark">Para restablecer la contraseña de su cuenta " {{env('APP_NAME')}} " haga click en el siguiente boton: </h4>
                <br>
                ...
                {{-- {{ env('ENDPOINT_BACK') }}confirmar-correo/{{ $data['email'] }}/{{ $data['token'] }} --}}
                  ...
                  <a href="{{env("ENDPOINT_FRONT")}}/restablecer-clave/{{$data['email']}}/{{$data['token_password']}}" class="button"> Restablecer contraseña  </a>
                <br>
                <br>
                <h4 class="text-dark">o copie y pegue en cualquier navegador: </h4>
                
                <h5 class="text-red-l" >{{env("ENDPOINT_FRONT")}}/restablecer-clave/{{$data['email']}}/{{$data['token_password']}}</h5>
